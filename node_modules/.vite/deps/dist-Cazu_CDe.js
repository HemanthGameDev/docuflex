import { Cn as Fragment, J as getExtensionField, R as findParentNodeClosestToPos, Vt as mergeAttributes, _ as callOrReturn, _n as Selection, dn as keydownHandler, fn as Decoration, gn as PluginKey, hn as Plugin, i as Extension, mn as NodeSelection, pn as DecorationSet, u as Node3, vn as SelectionRange, wn as Slice, xn as Transform, yn as TextSelection } from "./dist-CvlCtD-D.js";
	...
	parseMarkdown: (token, h) => {
		...
		if (token.header) {
			...
			token.header.forEach((cell) => {
				headerCells.push(h.createNode("tableHeader", {}, [{
					type: "paragraph",
		...
		if (token.rows) token.rows.forEach((row) => {
			const bodyCells = [];
			row.forEach((cell) => {
				bodyCells.push(h.createNode("tableCell", {}, [{
					type: "paragraph",
					content: h.parseInline(cell.tokens)
				}]));
			});
...
//#endregion
export { TableKit as a, createColGroup as c, updateColumns as d, TableHeader as i, createTable as l, Table as n, TableRow as o, TableCell as r, TableView as s, DEFAULT_CELL_LINE_SEPARATOR as t, renderTableToMarkdown as u };

//# sourceMappingURL=dist-Cazu_CDe.js.map