import { At as isNodeSelection, Cn as Fragment, J as getExtensionField, Jt as parseIndentedBlocks, Ot as isNodeActive, Qt as renderNestedMarkdownContent, Rt as markInputRule, Sn as dropPoint, Vt as mergeAttributes, Wt as nodeInputRule, _ as callOrReturn, _n as Selection$1, bn as Mapping, bt as isAtStartOfNode, c as Mark, cn as textblockTypeInputRule, dn as keydownHandler, et as getNodeAtPosition, fn as Decoration, gn as PluginKey, hn as Plugin, i as Extension, kt as isNodeEmpty, mn as NodeSelection, nt as getNodeType, pn as DecorationSet, rt as getRenderedAttributes, u as Node3, un as wrappingInputRule, v as canInsertNode, wn as Slice, yn as TextSelection, yt as isAtEndOfNode, zt as markPasteRule } from "./dist-CvlCtD-D.js";
import { t as Link } from "./dist-Bn9lflU2.js";
...
var ListItem = Node3.create({
	...
	parseMarkdown: (token, helpers) => {
		...
		let content = [];
		if (token.tokens && token.tokens.length > 0) if (token.tokens.some((t) => t.type === "paragraph")) content = helpers.parseChildren(token.tokens);
		else {
